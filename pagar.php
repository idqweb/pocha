		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-6 col-md-4">
						<form name="pagar" method="post" action="pagar.php">
							<div class="form-group">
								 <label class="control-label">Nº Jugadores</label>
								<input class="form-control" type="text" name="jugadorestotales" /><br/><br/>
			...
			<?php
				...
				$numerojugadores = $_POST['jugadorestotales'];
